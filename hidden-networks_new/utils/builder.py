...
class Builder(object):
    ...
    def conv(self, kernel_size, in_planes, out_planes, stride=1, first_layer=False, rank1=False):
        ...
        if kernel_size == 3:
            ...
            conv = conv_layer(
                in_planes, out_planes, rank1=rank1, kernel_size=1, stride=stride, bias=False
            )
        elif kernel_size == 5:
            conv = conv_layer(
                in_planes,
    ...
    def conv1x1_rank1(self, in_planes, out_planes, stride=1, first_layer=False):
        """1x1 convolution with padding"""
        c = self.conv(1, in_planes, out_planes, rank1=True, stride=stride, first_layer=first_layer)
        return c
