...
class LeNet300(object):
    def __init__(self,
        ...
        self.name = 'lenet300'
        self.input_dims = [32, 32, 3] #[28, 28, 1] #[32, 32, 3] # height, width, channel
    ...
    def construct_weights(self, initializer_w, initializer_b, trainable, scope):
        ...
        with tf.variable_scope(scope):
            weights['w1'] = tf.get_variable('w1', [32*32*3, 300], **w_params)#tf.get_variable('w1', [784, 300], **w_params) #tf.get_variable('w1', [32*32*3, 300], **w_params)
